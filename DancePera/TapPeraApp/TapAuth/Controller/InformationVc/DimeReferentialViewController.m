//
//  DimeReferentialViewController.m
//  TapPera
//
...
@interface DimeReferentialViewController (){
    NSString *startTime;
    NSString *endTime;
}
...
@implementation DimeReferentialViewController
...
- (void)comFirmWallet{
    ...
    NSDictionary *dict = @{@"beats":_beats,@"uncut":@"1"};
