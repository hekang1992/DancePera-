...
- (void)hashFragmentationUpdate {
    if (self.navigationController && [self.navigationController isKindOfClass:[BoxingRabbahNavigationController class]]) {
        BoxingRabbahNavigationController *nav = (BoxingRabbahNavigationController *)self.navigationController;
